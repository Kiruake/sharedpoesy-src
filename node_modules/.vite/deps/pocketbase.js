...
var AsyncAuthStore = class extends BaseAuthStore {
  constructor(e2) {
    super(), this.queue = [], this.saveFunc = e2.save, this.clearFunc = e2.clear, this._loadInitial(e2.initial);
  }
  save(e2, t2) {
    super.save(e2, t2);
    let i2 = "";
    try {
      i2 = JSON.stringify({ token: e2, model: t2 });
    } catch (e3) {
      console.warn("AsyncAuthStore: failed to stringify the new state");
    }
    this._enqueue(() => this.saveFunc(i2));
  }
  clear() {
  ...
  _loadInitial(e2) {
    if (e2)
      try {
        ...
        this.save(t2.token || "", t2.model || null);
      } catch (e3) {
      }
  }
  _enqueue(e2) {
